  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{
        ...
        /* Backgrounds */
        html.dark .bg-white { background-color: rgba(30, 41, 59, 0.7) !important; backdrop-filter: blur(16px) !important; -webkit-backdrop-filter: blur(16px) !important; border-color: rgba(255, 255, 255, 0.05) !important; }
        html.dark .bg-white\\/80 { background-color: rgba(30, 41, 59, 0.8) !important; border-color: rgba(255, 255, 255, 0.05) !important; }
        ...
        html.dark .bg-emerald-50, html.dark .bg-emerald-100, html.dark .bg-emerald-50\\/50, html.dark .bg-green-50, html.dark .bg-\\[\\#e6fbf0\\] { background-color: rgba(16, 185, 129, 0.15) !important; color: #34d399 !important; border-color: rgba(16, 185, 129, 0.2) !important; }
        html.dark .bg-blue-50, html.dark .bg-blue-100, html.dark .bg-blue-50\\/50 { background-color: rgba(59, 130, 246, 0.15) !important; color: #60a5fa !important; border-color: rgba(59, 130, 246, 0.2) !important; }
        html.dark .bg-purple-50, html.dark .bg-purple-100, html.dark .bg-purple-50\\/50 { background-color: rgba(168, 85, 247, 0.15) !important; color: #c084fc !important; border-color: rgba(168, 85, 247, 0.2) !important; }
        html.dark .bg-orange-50, html.dark .bg-orange-100, html.dark .bg-orange-50\\/50 { background-color: rgba(249, 115, 22, 0.15) !important; color: #fb923c !important; border-color: rgba(249, 115, 22, 0.2) !important; }
        html.dark .bg-red-50, html.dark .bg-red-100, html.dark .bg-red-50\\/50 { background-color: rgba(239, 68, 68, 0.15) !important; color: #f87171 !important; border-color: rgba(239, 68, 68, 0.2) !important; }
        html.dark .bg-amber-50, html.dark .bg-amber-100, html.dark .bg-amber-50\\/50 { background-color: rgba(245, 158, 11, 0.15) !important; color: #fbbf24 !important; border-color: rgba(245, 158, 11, 0.2) !important; }
        html.dark .bg-indigo-50, html.dark .bg-indigo-100, html.dark .bg-indigo-50\\/50 { background-color: rgba(99, 102, 241, 0.15) !important; color: #818cf8 !important; border-color: rgba(99, 102, 241, 0.2) !important; }
        ...
        html.dark input:not([type="checkbox"]):not([type="radio"]), html.dark select, html.dark textarea { background-color: rgba(15, 23, 42, 0.5) !important; backdrop-filter: blur(12px) !important; -webkit-backdrop-filter: blur(12px) !important; color: #f8fafc !important; border-color: rgba(255, 255, 255, 0.1) !important; box-shadow: inset 0 2px 4px rgba(0,0,0,0.2) !important; }
        
        /* Fix Input Error & State Warna Keras */
        html.dark input.\\!text-red-600 { color: #ef4444 !important; border-color: #ef4444 !important; }
        html.dark input.\\!border-red-500 { border-color: #ef4444 !important; }
        ...
        /* Fix Warna Hover yang tertimpa global !important */
        html.dark .hover\\:text-red-500:hover { color: #ef4444 !important; }
        html.dark .hover\\:bg-blue-50:hover { background-color: rgba(59, 130, 246, 0.2) !important; color: #93c5fd !important; }
        html.dark .hover\\:bg-blue-50:hover * { color: #93c5fd !important; }
        ...
        /* Fix hover kolom sticky agar warnanya sinkron */
        html.dark .group:hover .group-hover\\:bg-slate-50 { background-color: #334155 !important; }
        html.dark .group:hover td.bg-white { background-color: #334155 !important; }
